...
Date: 2015-04-23 18:04:41
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `cdlx`
-- ----------------------------
DROP TABLE IF EXISTS `cdlx`;
CREATE TABLE `cdlx` (
`id`  int(11) NOT NULL ,
...
-- ----------------------------
BEGIN;
INSERT INTO `cdlx` VALUES ('1', '供电线路\r\n'), ('2', '10KV 配电室\r\n'), ('3', '主变压器\r\n'), ('4', '主变压器断路器\r\n'), ('5', '110KV 母线\r\n'), ('6', '110KV 母电压互感器\r\n'), ('7', '35KV 母电压互感器\r\n'), ('8', '主控室\r\n');
COMMIT;
...
`dDescribe`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
-- ----------------------------
BEGIN;
INSERT INTO `dept` VALUES ('1', '2000-01-01', '主管人事', '人事部'), ('2', '2000-01-01', '负责设备巡检', '巡检部');
COMMIT;
...
PRIMARY KEY (`id`),
INDEX `device_sblx` (`sblx_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=1
...
FOREIGN KEY (`task_id`) REFERENCES `task` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`xsbz_id`) REFERENCES `xsbz` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`xsnr_id`) REFERENCES `xsnr` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `history_task` (`task_id`) USING BTREE ,
INDEX `history_place` (`place_id`) USING BTREE ,
INDEX `history_device` (`device_id`) USING BTREE ,
INDEX `history_xsnr` (`xsnr_id`) USING BTREE ,
INDEX `history_xnbz` (`xsbz_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=1
...
`name`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
PRIMARY KEY (`id`),
FOREIGN KEY (`cdlx_id`) REFERENCES `cdlx` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `place_site` (`site_id`) USING BTREE ,
INDEX `place_cdlx` (`cdlx_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=11
...
-- ----------------------------
BEGIN;
INSERT INTO `place` VALUES ('1', '1', '1', '葛溪971线', '葛溪971线'), ('2', '1', '1', '葛洋972线', '葛洋972线'), ('3', '1', '1', '上章974线', '上章974线'), ('4', '1', '1', '新浦973线', '新浦973线'), ('5', '2', '1', '10KV 配电室', '10KV 配电室'), ('6', '3', '1', '1号主变压器', '1号主变压器'), ('7', '4', '1', '1号主变压器断路器', '1号主变压器断路器'), ('8', '3', '1', '2号主变压器', '2号主变压器'), ('9', '4', '1', '2号主变压器断路器', '2号主变压器断路器'), ('10', '8', '1', '主控室', '主控室');
COMMIT;
...
PRIMARY KEY (`id`),
FOREIGN KEY (`deptID`) REFERENCES `dept` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `pDeptID` (`deptID`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=3
...
-- ----------------------------
BEGIN;
INSERT INTO `position` VALUES ('1', '2', '巡检员', '负责设备巡检'), ('2', '1', '人事经理', '负责人事');
COMMIT;

-- ----------------------------
-- Table structure for `rwlx`
-- ----------------------------
DROP TABLE IF EXISTS `rwlx`;
CREATE TABLE `rwlx` (
`id`  int(11) NOT NULL AUTO_INCREMENT ,
`name`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
-- ----------------------------
BEGIN;
INSERT INTO `rwlx` VALUES ('1', '日常巡视', '每日至少一次'), ('2', '夜间熄灯巡视', '每周至少一次'), ('3', '特殊巡视', '重点设备、薄弱设备巡视'), ('4', '高峰负荷巡视', '35℃以上巡视'), ('5', '特殊天气巡视', '大风、大雪、大雾、雷暴天气巡视');
COMMIT;
...
PRIMARY KEY (`id`),
INDEX `sblx_cdlx` (`cdlx_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
-- ----------------------------
BEGIN;
INSERT INTO `sblx` VALUES ('1', '1', '线路开关\r\n', ''), ('2', '2', '高压室\r\n', ''), ('3', '2', '电压互感器\r\n', ''), ('4', '2', '主变低压侧开关柜\r\n', ''), ('5', '2', '线路开关\r\n', ''), ('6', '2', '站用变\r\n', ''), ('7', '2', '站用变本体\r\n', ''), ('8', '3', '主变本体\r\n', ''), ('9', '3', '主变套管\r\n', ''), ('10', '3', '主变外部主导流部位\r\n', ''), ('11', '3', '主变风冷系统\r\n', ''), ('12', '3', '主变中性点设备\r\n', ''), ('13', '3', '主变端子箱\r\n', ''), ('14', '4', '主变中压侧开关柜\r\n', ''), ('15', '5', '母线\r\n', ''), ('16', '6', '电压互感器\r\n', ''), ('17', '6', '避雷器\r\n', ''), ('18', '6', '隔离开关\r\n', ''), ('19', '7', '电压互感器\r\n', ''), ('20', '8', '主控室\r\n', ''), ('21', '8', '远动屏\r\n', ''), ('22', '8', '主变及各线路测控屏\r\n', ''), ('23', '8', '主控桌设备\r\n', ''), ('24', '8', '直流系统\r\n', ''), ('25', '8', '1号主变保护屏\r\n', ''), ('26', '8', '备自投屏\r\n', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `site` VALUES ('1', '筱村35KV变电站', '浙江省温州市泰顺县筱村镇', '筱村35KV变电站', null, '浙江省', '温州市', '泰顺县', '筱村');
COMMIT;
...
PRIMARY KEY (`id`),
FOREIGN KEY (`rwlx_id`) REFERENCES `rwlx` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`from`) REFERENCES `user` (`account`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `rwlx` (`rwlx_id`) USING BTREE ,
INDEX `task_site` (`site_id`) USING BTREE ,
INDEX `task_to` (`to`) USING BTREE ,
INDEX `task_from` (`from`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=2
...
-- ----------------------------
BEGIN;
INSERT INTO `task` VALUES ('1', '1', '116040383', '116040384', '2015-04-23', '13:42', '1', 'unfinished');
COMMIT;
...
PRIMARY KEY (`id`),
FOREIGN KEY (`positionID`) REFERENCES `position` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
FOREIGN KEY (`deptID`) REFERENCES `dept` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `positionID` (`positionID`) USING BTREE ,
INDEX `uDeptID` (`deptID`) USING BTREE ,
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', '116040384', '厉圣杰', '111111', '/img/user/116040384.jpg', '初次见面，请多指教', '18815283020', '1025263614@qq.com', '2', '1', '2008-01-01'), ('2', '116040383', 'Boss', '111111', null, '初次见面，请多指教！', '18067523878', '1025263614lsj@gmail.com', '1', '2', '2008-01-01');
COMMIT;

-- ----------------------------
-- Table structure for `xsbz`
-- ----------------------------
DROP TABLE IF EXISTS `xsbz`;
CREATE TABLE `xsbz` (
`id`  int(11) NOT NULL ,
`sblx_id`  int(11) NOT NULL ,
`xsnr_id`  int(11) NOT NULL ,
...
PRIMARY KEY (`id`),
FOREIGN KEY (`xsnr_id`) REFERENCES `xsnr` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
INDEX `xsbz_sblx` (`sblx_id`) USING BTREE ,
INDEX `xsbz_xsnr` (`xsnr_id`) USING BTREE 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
-- ----------------------------
ALTER TABLE `place` AUTO_INCREMENT=11;
...
-- ----------------------------
-- Auto increment value for `rwlx`
-- ----------------------------
ALTER TABLE `rwlx` AUTO_INCREMENT=6;

-- ----------------------------
-- Auto increment value for `site`
-- ----------------------------
ALTER TABLE `site` AUTO_INCREMENT=2;
