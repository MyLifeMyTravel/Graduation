 				...
 				<div class="right">
                    ...
                    <div class="shebeiadd_form">
                    	<form action="php/shebei_add_submit.php" method="post">
                            ...
                            <option value="主变压器">主变压器</option>
                            <option value="互感器">互感器</option>
                            <option value="真空断路器">真空断路器</option>
                            <option value="SF6断路器">SF6断路器</option>
                            <option value="隔离开关">隔离开关</option>
                            <option value="电容器">电容器</option>
                            <option value="电抗器">电抗器</option>
                            <option value="抗雷圈">抗雷圈</option>
                            <option value="避雷针及避雷器">避雷针及避雷器</option>
                            <option value="端子箱">端子箱</option>
                            <option value="交直流盘及蓄电池组">交直流盘及蓄电池组</option>
                            <option value="动补保护控制柜">动补保护控制柜</option>
                            <option value="树脂浇注干式变压器">树脂浇注干式变压器</option>
                            <option value="智能在线验电装置">智能在线验电装置</option>
                            ...
                            <textarea name="device_parameter" cols="40" rows="7"></textarea><br  /><br  />
