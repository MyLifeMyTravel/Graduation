...
<body>
 				<div class="right">
                    ...
                    <div class="right_shebeiadd_1">
                        ...
                        <a href="user_add.php" target="main">添加部门</a>
                    ...
                    <div class="shebeimanage_table">
						<table>
                        <tr><!-- 是否要显示密码呢？ -->
                        <th>部门编号</th><th>部门名称</th><th>部门主管</th><th>部门简介</th><th><a href="#">编辑</a></th><th><a href="#">删除</a></th>
                        </tr>
                        <?php include('php/department_manage_show_table.php'); ?>
                        </table> 
                    </div>
                </div><!--right结束-->
